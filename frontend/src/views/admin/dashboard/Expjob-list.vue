<template>
  <div class="formofwork-list">
    <h2 class="mt-5">Danh Sách Kinh Nghiệm Làm Việc</h2>
    ...
    <div class="card mt-5">
      ...
      <div class="card-body">
        ...
        <div v-else>
          ...
          <!-- Phân trang -->
          <nav
            v-if="experienceStore.totalPages > 1"
            aria-label="Page navigation"
          >
            <ul class="pagination justify-content-center">
              <li
                class="page-item"
                :class="{ disabled: experienceStore.currentPage === 1 }"
              >
              ...
              <li
                v-for="page in experienceStore.totalPages"
                :key="page"
                class="page-item"
        ...
        <div class="modal-body">
          <div>
            ...
            <input
              type="text"
              class="form-control"
              v-model="newExperience.experienceName"
              :disabled="experienceStore.isLoading"
            />
        ...
        <div class="modal-body">
          <div>
            ...
            <input
              type="text"
              class="form-control"
              v-model="updateExperience.experienceName"
              :disabled="experienceStore.isLoading"
            />
            <small v-if="experienceStore.error" class="text-danger">
              {{ experienceStore.error }}

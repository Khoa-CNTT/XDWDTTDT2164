        ...
        <div class="container-fluid mt-4">
            <div class="row">
                <div class="col-lg-7 col-md-12">
                    ...
                    <div class="card mt-4 p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <select v-model="selectedPostFilter" @change="updatePostChart" class="form-select"
                                style="width: 100px;">
                    ...
                    <div class="card mt-4 p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <select v-model="selectedCandidateFilter" @change="updateCandidateChart" class="form-select"
                                style="width: 100px;">
                                <option value="day">Theo ngày</option>
                                <option value="month">Theo tháng</option>
                                <option value="year">Theo năm</option>
                ...
                <div class="col-lg-5 col-md-12">
                    <div class="card">
                        <div class="card-header text-center bg-primary text-white align-items-center" style="padding: 10px;">
                            <h3>THÔNG BÁO</h3>
                        </div>
                        <div class="card-body">
                            <div>
...
export default {
    data() {
        return {
            ...
            BD_Data: {
                day: { labels: ["Thứ 2", "Thứ 3", "Thứ 4", "Thứ 5", "Thứ 6", "Thứ 7", "CN"], data: [35, 50, 40, 52, 30, 12, 7] },
                month: { labels: ["Tháng 1", "Tháng 2", "Tháng 3", "Tháng 4", "Tháng 5", "Tháng 6", "Tháng 7", "Tháng 8", "Tháng 9", "Tháng 10", "Tháng 11", "Tháng 12"], data: [200, 320, 280, 400, 350, 270, 200, 320, 280, 400, 350, 270] },
                year: { labels: ["2020", "2021", "2022", "2023", "2024"], data: [1200, 1500, 1800, 2100, 2500] }
            },
            candidateData: {
                day: { labels: ["Thứ 2", "Thứ 3", "Thứ 4", "Thứ 5", "Thứ 6", "Thứ 7", "CN"], data: [25, 40, 30, 45, 20, 10, 5] },
                month: { labels: ["Tháng 1", "Tháng 2", "Tháng 3", "Tháng 4", "Tháng 5", "Tháng 6", "Tháng 7", "Tháng 8", "Tháng 9", "Tháng 10", "Tháng 11", "Tháng 12"], data: [180, 300, 250, 380, 320, 240, 180, 300, 250, 380, 320, 240] },
                year: { labels: ["2020", "2021", "2022", "2023", "2024"], data: [1000, 1300, 1600, 1900, 2200] }
            }
        };
    },
    mounted() {

              ...
              <table class="table table-hover align-middle">
                <thead class="bg-light">
                  <tr>
                    <th>STT</th>
                    <th>Thời gian</th>
                    <th class="text-danger">Phí thanh toán</th>
                    <th>Số dư đầu</th>
                    <th>Số dư cuối</th>
                    <th>Mã bài đăng</th>
                    <th>Tên bài đăng</th>
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td>{{ formatNumber(payment.balanceBefore) }}</td>
                    <td>{{ formatNumber(payment.balanceAfter) }}</td>
                    <td>
                      <span class="text-primary">{{ payment.postId }}</span>
                    </td>
                    <td>{{ payment.postTitle }}</td>
                  </tr>
                  <!-- Empty State -->
                  <tr v-if="!walletStore.historyPayments?.length">

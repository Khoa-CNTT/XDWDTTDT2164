  ...
  <div class="container py-4">
    <div class="row justify-content-center">
      <div>
        <!-- Header -->
        <div class="mb-4">
          <h2 class="mb-2">Nạp tiền vào tài khoản</h2>
          <div>
        ...
        <div class="card border-0 rounded-4">
          <div class="card-body p-4">
            ...
            <!-- Payment Methods -->
            <div>
              <h6 class="mb-3">Chọn phương thức nạp tiền</h6>

              <!-- MOMO -->
              <div
                class="card border hover-shadow-sm mb-3 cursor-pointer"
                ...
                <div class="card-body p-3">
                  ...
                  >
                    <div class="d-flex align-items-center">
                      <div class="me-3">Ví điện tử MOMO</div>
                    </div>
                    <img
              ...
              >
                <div class="card-body p-3">
                  ...
                  >
                    <div class="d-flex align-items-center">
                      <div class="me-3">Ví điện tử ZALOPAY</div>
                    </div>
                    <img
              ...
              <!-- VNPAY -->
              <div
                class="card border hover-shadow-sm cursor-pointer"
              ...
              >
                <div class="card-body p-3">
                  ...
                  >
                    <div class="d-flex align-items-center">
                      <div class="me-3">Ví điện tử VNPAY</div>
                    </div>
                    <img
...
export default {
  ...
  methods: {
    selectPaymentMethod(method) {
      // Chuyển hướng đến DepositInfoView với phương thức thanh toán
      this.$router.push({
        path: "/employer-dashboard/employer-depositinformation",
